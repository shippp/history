...
class CacheConfig:
    ...
    def from_base_dir(cls, base_dir: Path) -> "CacheConfig":
        ...
        return cls(base_dir=base_dir, dem_diff_dir=base_dir / "dem_diff")
...
class ProcConfig:
    ...
    cache : CacheConfig
        Disposable cache data (e.g. provided DEM vs. reference DEM diffs) that
        can be safely deleted and recomputed.
    """
